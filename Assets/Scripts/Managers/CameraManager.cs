...
public class CameraManager : MonoBehaviour
{
    ...
    private void Start()
    {
        InputManager.Instance.playerInput.InGame.CameraZoom.started += Zoom;
        InputManager.Instance.playerInput.InGame.CameraMove.started += ClickStart;
        InputManager.Instance.playerInput.InGame.CameraMove.canceled += ClickEnd;
    ...
    void DragCamera()
    {
        Vector2 inputValue = InputManager.Instance.playerInput.InGame.M_MouseMove.ReadValue<Vector2>();
